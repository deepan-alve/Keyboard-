...
import com.azhagi.azhagikeys.ime.editor.EditorContent
import com.azhagi.azhagikeys.ime.editor.AzhagiEditorInfo
import com.azhagi.azhagikeys.ime.editor.ImeOptions
import com.azhagi.azhagikeys.ime.editor.InputAttributes
...
import com.azhagi.azhagikeys.ime.text.keyboard.TextKeyboardCache
...
import com.azhagi.azhagikeys.lib.titlecase
...
class KeyboardManager(context: Context) : InputKeyEventReceiver {
     ...
     * AzhagiKeys internal or system-wide.
     */
    private fun handleLanguageSwitch() {
        when (prefs.keyboard.utilityKeyAction.get()) {
            ...
            else -> AzhagiImeService.switchToNextInputMethod()
        }
    }
        ...
        lastToastReference = WeakReference(
            if (newState) {
                appContext.showLongToast(
                    ...
                    "app_name" to appContext.getString(R.string.azhagi_app_name),
                )
            } else {
                appContext.showLongToast(
    ...
    override fun onInputKeyUp(data: KeyData) = activeState.batchEdit {
        when (data.code) {
            ...
            KeyCode.IME_SHOW_UI -> AzhagiImeService.showUi()
            KeyCode.IME_HIDE_UI -> AzhagiImeService.hideUi()
            ...
            KeyCode.VOICE_INPUT -> AzhagiImeService.switchToVoiceInputMethod()
            ...
            KeyCode.SETTINGS -> AzhagiImeService.launchSettings()
            ...
            KeyCode.SYSTEM_PREV_INPUT_METHOD -> AzhagiImeService.switchToPrevInputMethod()
            KeyCode.SYSTEM_NEXT_INPUT_METHOD -> AzhagiImeService.switchToNextInputMethod()
    ...
    override fun onInputKeyRepeat(data: KeyData) {
        AzhagiImeService.inputFeedbackController()?.keyRepeatedAction(data)
        when (data.code) {
            KeyCode.ARROW_DOWN,
            KeyCode.ARROW_LEFT,
            KeyCode.ARROW_RIGHT,
    ...
    private inner class ComputingEvaluatorImpl(
        ...
        override val editorInfo: AzhagiEditorInfo,
