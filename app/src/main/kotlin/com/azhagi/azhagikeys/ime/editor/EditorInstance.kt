...
class EditorInstance(context: Context) : AbstractEditorInstance(context) {
    ...
    override fun handleStartInputView(editorInfo: AzhagiEditorInfo, isRestart: Boolean) {
    ...
    override fun shouldDetermineComposingRegion(editorInfo: AzhagiEditorInfo): Boolean {
