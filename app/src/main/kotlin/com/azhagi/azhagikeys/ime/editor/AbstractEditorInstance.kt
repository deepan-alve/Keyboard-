...
package com.azhagi.azhagikeys.ime.editor
...
import com.azhagi.azhagikeys.ime.nlp.BreakIteratorGroup
...
abstract class AbstractEditorInstance(context: Context) {
    ...
    private val _activeInfoFlow = MutableStateFlow(AzhagiEditorInfo.Unspecified)
    val activeInfoFlow = _activeInfoFlow.asStateFlow()
    inline var activeInfo: AzhagiEditorInfo
    ...
    private fun currentInputConnection() = AzhagiImeService.currentInputConnection()

    open fun handleStartInput(editorInfo: AzhagiEditorInfo) {
    ...
    open fun handleStartInputView(editorInfo: AzhagiEditorInfo, isRestart: Boolean) {
        if (isRestart) {
    ...
    protected open fun reset() {
        activeInfo = AzhagiEditorInfo.Unspecified
        activeCursorCapsMode = InputAttributes.CapsMode.NONE
        activeContent = EditorContent.Unspecified
    ...
    private suspend fun EditorContent.generateCopy(
        editorInfo: AzhagiEditorInfo = activeInfo,
    ...
    protected open fun shouldDetermineComposingRegion(editorInfo: AzhagiEditorInfo): Boolean {
