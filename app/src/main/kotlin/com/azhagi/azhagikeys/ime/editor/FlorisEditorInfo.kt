...
class AzhagiEditorInfo private constructor(val base: EditorInfo) {
    ...
    companion object {
        val Unspecified = AzhagiEditorInfo(EditorInfo())

        fun wrap(editorInfo: EditorInfo) = AzhagiEditorInfo(editorInfo)
    }
}
