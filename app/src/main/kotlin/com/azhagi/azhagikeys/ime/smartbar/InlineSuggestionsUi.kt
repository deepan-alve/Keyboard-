...
import com.azhagi.azhagikeys.ime.nlp.NlpInlineAutofillSuggestion
...
import org.azhagi.lib.snygg.SnyggPropertySet
...
fun InlineSuggestionsStyleCache() {
    val chipStyleSet = rememberSnyggThemeQuery(AzhagiImeUi.InlineAutofillChip.elementName)
