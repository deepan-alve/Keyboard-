...
import com.azhagi.azhagikeys.ime.keyboard.LayoutTypeId
import com.azhagi.azhagikeys.ime.keyboard.extCoreComposer
import com.azhagi.azhagikeys.ime.keyboard.extCoreCurrencySet
import com.azhagi.azhagikeys.ime.keyboard.extCoreLayout
import com.azhagi.azhagikeys.ime.keyboard.extCorePopupMapping
import com.azhagi.azhagikeys.ime.keyboard.extCorePunctuationRule
...
data class Subtype(
    val id: Long,
    val primaryLocale: AzhagiLocale,
    val secondaryLocales: List<AzhagiLocale>,
    ...
    companion object {
        ...
        val DEFAULT = Subtype(
            id = -1,
            primaryLocale = AzhagiLocale.from("en", "US"),
