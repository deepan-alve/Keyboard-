...
fun rememberPopupUiController(
    key1: Any?,
    key2: Any?,
    boundsProvider: (key: Key) -> AzhagiRect,
...
class PopupUiController(
    val context: Context,
    val boundsProvider: (key: Key) -> AzhagiRect,
