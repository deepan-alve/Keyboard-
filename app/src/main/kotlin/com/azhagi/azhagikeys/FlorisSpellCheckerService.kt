...
class AzhagiSpellCheckerService : SpellCheckerService() {
    ...
    override fun createSession(): Session {
        ...
        return AzhagiSpellCheckerSession()
    }
    ...
    private inner class AzhagiSpellCheckerSession : Session() {
        ...
        private fun setupSpellingIfNecessary() {
            val evaluatedSubtype = when (prefs.spelling.languageMode.get()) {
                SpellingLanguageMode.USE_KEYBOARD_SUBTYPES -> {
                    ...
                    Subtype.DEFAULT.copy(primaryLocale = AzhagiLocale.default())
                }
            }
