...
import com.azhagi.azhagikeys.ime.dictionary.AzhagiUserDictionaryDatabase
...
@Composable
fun DevtoolsScreen() = AzhagiScreen {
            ...
            AzhagiConfirmDeleteDialog(
                onConfirm = {
                    DictionaryManager.default().let {
                        ...
                        it.AzhagiUserDictionaryDao()?.deleteAll()
                    }
                    setShowDialog(false)
                },
                onDismiss = { setShowDialog(false) },
                what = AzhagiUserDictionaryDatabase.DB_FILE_NAME,
            )
        }
    }
}
