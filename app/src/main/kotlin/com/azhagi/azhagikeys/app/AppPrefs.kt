...
import com.azhagi.azhagikeys.app.settings.theme.DisplayKbdAfterDialogs
import com.azhagi.azhagikeys.app.settings.theme.SnyggLevel
import com.azhagi.azhagikeys.app.setup.NotificationPermissionState
import com.azhagi.azhagikeys.ime.clipboard.CLIPBOARD_HISTORY_NUM_GRID_COLUMNS_AUTO
...
import com.azhagi.azhagikeys.ime.input.HapticVibrationMode
import com.azhagi.azhagikeys.ime.input.InputFeedbackActivationMode
import com.azhagi.azhagikeys.ime.keyboard.IncognitoMode
...
import com.azhagi.azhagikeys.ime.media.emoji.EmojiHairStyle
import com.azhagi.azhagikeys.ime.media.emoji.EmojiHistory
import com.azhagi.azhagikeys.ime.media.emoji.EmojiSkinTone
import com.azhagi.azhagikeys.ime.media.emoji.EmojiSuggestionType
import com.azhagi.azhagikeys.ime.nlp.SpellingLanguageMode
import com.azhagi.azhagikeys.ime.onehanded.OneHandedMode
import com.azhagi.azhagikeys.ime.smartbar.CandidatesDisplayMode
...
import com.azhagi.azhagikeys.ime.smartbar.quickaction.QuickAction
import com.azhagi.azhagikeys.ime.smartbar.quickaction.QuickActionArrangement
import com.azhagi.azhagikeys.ime.smartbar.quickaction.QuickActionJsonConfig
import com.azhagi.azhagikeys.ime.text.gestures.SwipeAction
import com.azhagi.azhagikeys.ime.text.key.KeyCode
import com.azhagi.azhagikeys.ime.text.key.KeyHintConfiguration
...
import com.azhagi.azhagikeys.ime.theme.extCoreTheme
import com.azhagi.azhagikeys.lib.compose.ColorPreferenceSerializer
import com.azhagi.azhagikeys.lib.ext.ExtensionComponentName
import com.azhagi.azhagikeys.lib.observeAsTransformingState
import com.azhagi.azhagikeys.lib.util.VersionName
...
fun AzhagiPreferenceModel() = JetPref.getOrCreatePreferenceModel(AppPrefs::class, ::AppPrefs)

class AppPrefs : PreferenceModel("AzhagiKeys-app-prefs") {
    ...
    inner class Clipboard {
        ...
        val syncToAzhagi = boolean(
            key = "clipboard__sync_to_Azhagi",
            default = true,
        )
    ...
    inner class Dictionary {
        ...
        val enableAzhagiUserDictionary = boolean(
            key = "suggestion__enable_Azhagi_user_dictionary",
            default = true,
        )
    }
    ...
    inner class Theme {
        ...
        val dayThemeId = custom(
            ...
            default = extCoreTheme("Azhagi_day"),
            serializer = ExtensionComponentName.Serializer,
        )
        val nightThemeId = custom(
            key = "theme__night_theme_id",
            default = extCoreTheme("Azhagi_night"),
            serializer = ExtensionComponentName.Serializer,
        )
        val accentColor = custom(
        ...
        return when (entry.key) {
            ...
            "media__emoji_recently_used" -> {
                ...
                val recent = emojiValues.map {
                    com.azhagi.azhagikeys.ime.media.emoji.Emoji(it, "", emptyList())
                }
