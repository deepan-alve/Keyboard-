...
fun TypingScreen() = AzhagiScreen {
    ...
    content {
                ...
                Card(modifier = Modifier.padding(8.dp)) {
                    Column(modifier = Modifier.padding(8.dp)) {
                        ...
                        AzhagiHyperlinkText(
                            ...
                            url = "https://github.com/AzhagiKeys/AzhagiKeys/discussions/1935",
                        )
                    }
                }
            }
        ...
        PreferenceGroup(title = stringRes(R.string.pref__spelling__title)) {
            val AzhagiSpellCheckerEnabled = remember { mutableStateOf(false) }
            SpellCheckerServiceSelector(AzhagiSpellCheckerEnabled)
            ListPreference(
                ...
                enabledIf = { AzhagiSpellCheckerEnabled.value },
            )
            SwitchPreference(
