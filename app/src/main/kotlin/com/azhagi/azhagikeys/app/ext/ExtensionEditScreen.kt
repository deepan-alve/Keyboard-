...
import com.azhagi.azhagikeys.app.settings.advanced.RadioListItem
import com.azhagi.azhagikeys.app.settings.theme.DialogProperty
import com.azhagi.azhagikeys.app.settings.theme.PrettyPrintConfig
import com.azhagi.azhagikeys.app.settings.theme.ThemeEditorScreen
...
import com.azhagi.azhagikeys.lib.compose.AzhagiUnsavedChangesDialog
...
import com.azhagi.azhagikeys.lib.ext.validate
...
private fun EditScreen(
    ...
    val extEditor = workspace.editor ?: return@AzhagiScreen
    ...
    fun handleSave() {
        ...
        val sourceRef = if (isCreateExt) {
            AzhagiRef.internal(ExtensionManager.IME_THEME_PATH).subRef(flexArchiveName)
        } else {
...
private fun ManageMetaDataScreen(
    ...
    val meta = workspace.editor?.meta ?: return@AzhagiScreen
...
@Composable
private fun ManageDependenciesScreen(workspace: CacheManager.ExtEditorWorkspace<*>) = AzhagiScreen {
    title = stringRes(R.string.ext__editor__dependencies__title)

    val dependencyList = workspace.editor?.dependencies ?: return@AzhagiScreen
