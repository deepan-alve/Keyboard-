...
import com.azhagi.azhagikeys.app.devtools.AndroidLocalesScreen
import com.azhagi.azhagikeys.app.devtools.AndroidSettingsScreen
import com.azhagi.azhagikeys.app.devtools.DevtoolsScreen
import com.azhagi.azhagikeys.app.devtools.ExportDebugLogScreen
import com.azhagi.azhagikeys.app.ext.CheckUpdatesScreen
import com.azhagi.azhagikeys.app.ext.ExtensionEditScreen
import com.azhagi.azhagikeys.app.ext.ExtensionExportScreen
import com.azhagi.azhagikeys.app.ext.ExtensionHomeScreen
import com.azhagi.azhagikeys.app.ext.ExtensionImportScreen
import com.azhagi.azhagikeys.app.ext.ExtensionImportScreenType
import com.azhagi.azhagikeys.app.ext.ExtensionListScreen
import com.azhagi.azhagikeys.app.ext.ExtensionListScreenType
import com.azhagi.azhagikeys.app.ext.ExtensionViewScreen
import com.azhagi.azhagikeys.app.settings.HomeScreen
import com.azhagi.azhagikeys.app.settings.about.AboutScreen
import com.azhagi.azhagikeys.app.settings.about.ProjectLicenseScreen
import com.azhagi.azhagikeys.app.settings.about.ThirdPartyLicensesScreen
import com.azhagi.azhagikeys.app.settings.advanced.OtherScreen
import com.azhagi.azhagikeys.app.settings.advanced.BackupScreen
import com.azhagi.azhagikeys.app.settings.advanced.RestoreScreen
import com.azhagi.azhagikeys.app.settings.clipboard.ClipboardScreen
import com.azhagi.azhagikeys.app.settings.dictionary.DictionaryScreen
import com.azhagi.azhagikeys.app.settings.dictionary.UserDictionaryScreen
import com.azhagi.azhagikeys.app.settings.dictionary.UserDictionaryType
import com.azhagi.azhagikeys.app.settings.gestures.GesturesScreen
import com.azhagi.azhagikeys.app.settings.keyboard.InputFeedbackScreen
import com.azhagi.azhagikeys.app.settings.keyboard.KeyboardScreen
import com.azhagi.azhagikeys.app.settings.localization.LanguagePackManagerScreen
import com.azhagi.azhagikeys.app.settings.localization.LanguagePackManagerScreenAction
import com.azhagi.azhagikeys.app.settings.localization.LocalizationScreen
import com.azhagi.azhagikeys.app.settings.localization.SelectLocaleScreen
import com.azhagi.azhagikeys.app.settings.localization.SubtypeEditorScreen
import com.azhagi.azhagikeys.app.settings.media.MediaScreen
import com.azhagi.azhagikeys.app.settings.smartbar.SmartbarScreen
import com.azhagi.azhagikeys.app.settings.theme.ThemeManagerScreen
import com.azhagi.azhagikeys.app.settings.theme.ThemeManagerScreenAction
import com.azhagi.azhagikeys.app.settings.theme.ThemeScreen
import com.azhagi.azhagikeys.app.settings.typing.TypingScreen
import com.azhagi.azhagikeys.app.setup.SetupScreen
...
object Routes {
    ...
    fun AppNavHost(
        ...
        fun NavGraphBuilder.composableWithDeepLink(
            ...
            composable(
                route = route,
                deepLinks = listOf(navDeepLink { uriPattern = "ui://AzhagiKeys/$route" }),
                content = content,
            )
        }
