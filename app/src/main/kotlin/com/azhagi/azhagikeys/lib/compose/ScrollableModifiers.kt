...
fun Modifier.AzhagiVerticalScroll(
    ...
    if (showScrollbar) {
        verticalScroll(scrollState).AzhagiScrollbar(scrollState, scrollbarWidth, isVertical = true)
    } else {
        verticalScroll(scrollState)
    }
}

fun Modifier.AzhagiHorizontalScroll(
    state: ScrollState? = null,
    showScrollbar: Boolean = true,
    ...
    val scrollState = state ?: rememberScrollState()
    if (showScrollbar) {
        horizontalScroll(scrollState).AzhagiScrollbar(scrollState, scrollbarHeight, isVertical = false)
    } else {
        horizontalScroll(scrollState)
    }
}

fun Modifier.AzhagiScrollbar(
    state: ScrollState,
