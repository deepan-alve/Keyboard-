...
package com.azhagi.azhagikeys.lib.crashutility
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val versionName = buildString {
            ...
            if (BuildConfig.DEBUG) {
                append(stringRes(R.string.AzhagiKeys__commit_by_hash_url, "hash" to BuildConfig.BUILD_COMMIT_HASH))
            } else {
                append(stringRes(R.string.AzhagiKeys__changelog_url, "version" to BuildConfig.VERSION_NAME))
            }
            append(")")
        }
        errorReport.apply {
            appendLine("#### Environment information")
            appendLine("- AzhagiKeys $versionName (${BuildConfig.VERSION_CODE})")
        ...
        openBugReportForm.setOnClickListener {
            val browserIntent = Intent(
                Intent.ACTION_VIEW,
                Uri.parse(resources.getString(R.string.AzhagiKeys__issue_tracker_url))
            )
