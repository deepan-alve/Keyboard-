...
package com.azhagi.azhagikeys.lib.ext
...
import com.azhagi.azhagikeys.ime.text.composing.Appender
import com.azhagi.azhagikeys.ime.text.composing.Composer
import com.azhagi.azhagikeys.ime.text.composing.HangulUnicode
import com.azhagi.azhagikeys.ime.text.composing.KanaUnicode
import com.azhagi.azhagikeys.ime.text.composing.WithRules
...
import com.azhagi.azhagikeys.lib.io.delete
import com.azhagi.azhagikeys.lib.io.listDirs
import com.azhagi.azhagikeys.lib.io.listFiles
import com.azhagi.azhagikeys.lib.io.loadJsonAsset
...
class ExtensionManager(context: Context) {
    ...
    fun import(ext: Extension) {
        ...
        ext.sourceRef = AzhagiRef.internal(relGroupPath).subRef(extFileName)
    ...
    inner class ExtensionIndex<T : Extension>(
        ...
        private val assetsModuleRef = AzhagiRef.assets(modulePath)
        private val internalModuleRef = AzhagiRef.internal(modulePath)
