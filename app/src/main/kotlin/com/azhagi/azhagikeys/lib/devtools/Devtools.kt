...
import com.azhagi.azhagikeys.lib.util.TimeUtils
import com.azhagi.azhagikeys.lib.util.UnitUtils
...
object Devtools {
    ...
    fun generateAppInfoLog(context: Context, withTitle: Boolean = true): String {
        return buildString {
            ...
            append("Name                : ").appendLine(context.resources.getString(R.string.azhagi_app_name))
